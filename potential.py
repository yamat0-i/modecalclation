...
F660_10_Lin = get_force(wavelength=660e-9,
                    ...
                    power=10e-3,
                    state='Lin')
F660_9_Lin = get_force(wavelength=660e-9,
                    radius=radius_list,
                    power=9e-3,
                    state='Lin')
F660_8_Lin = get_force(wavelength=660e-9,
                    radius=radius_list,
                    power=8e-3,
                    state='Lin')
...
ax.plot(radius_list, U1_norm, color='k', linestyle='solid', label='P=1.0')
ax.plot(radius_list, U2_norm, color='k', linestyle='dashed', label='P=0.9')
ax.plot(radius_list, U3_norm, color='k', linestyle='dashdot',label='P=0.8')
