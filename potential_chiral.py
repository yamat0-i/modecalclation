...
ax.plot(radius_list, U1_norm, color='k', linestyle='solid', label=r'$P=1.0, F_{660}=F^{achiral}_{rad}$')
ax.plot(radius_list, U2_norm, color='r', linestyle='solid', label=r'$P=1.0, F_{660}=F^{achiral}_{rad}+F^{chiral}_{rad}$')
ax.plot(radius_list, U3_norm, color='b', linestyle='solid', label=r'$P=1.0, F_{660}=F^{achiral}_{rad}-F^{chiral}_{rad}$')
