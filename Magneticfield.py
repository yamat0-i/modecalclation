...
Hx = HEmode.Hx(rho, phi, pol)
Hy = HEmode.Hy(rho, phi, pol)
Hz = HEmode.Hz(rho, phi, pol)
...
ax1.set_title(r'$|\boldsymbol{H}|^2$')
ax2.set_title(r'$|H_{x}|^2$')
ax3.set_title(r'$|H_{y}|^2$')
ax4.set_title(r'$|H_{z}|^2$')
...
ax2.pcolormesh(x, y, np.abs(Hx)**2)
...
ax3.pcolormesh(x, y, np.abs(Hy)**2)
...
ax4.pcolormesh(x, y, np.abs(Hz)**2)
